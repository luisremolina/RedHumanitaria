        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
              <form action="{{ route('kit.actualizar', $kit->id ) }}" method="POST">
                ...
                <input required placeholder="Nombre del Kit" class="form-control" type="text" name="name" value="{{$kit->nombre}}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="descripcion" placeholder="Descripcion del kit" cols="30" rows="5">{{$kit->descripcion}}
                  </textarea>
                </div>
